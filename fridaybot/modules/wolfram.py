...
async def _(event):
    ...
    if not event.reply_to_msg_id:
        ...
        if "Wolfram Alpha did not understand" in res.text:
            await event.edit(
                "Sorry, Friday's AI systems could't recognized your question.."
            )
            return
...
CMD_HELP.update(
    {
        "wolfram": "**Wolfwam**\
\n\n**Syntax : **`.friday <question>`\
\n**Usage :** Get Answers For The Qiestions\
\n**Example : **`.friday where is Taj Mahal`\
\n\n**Syntax :** `.friday <reply to voice audio>`\

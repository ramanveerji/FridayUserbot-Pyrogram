#    Copyright (C) @chsaiujwal 2020-2021-2021
...
async def _(event):
    ...
    querystring = {"season":"2020-2021","league":"39"}
...
async def _(event):
    ...
    appo = Config.FOOTBALL_API_KEY
    url = "https://api-football-beta.p.rapidapi.com/standings"
    querystring = {"season":"2020-2021-2021","league":"61"}
    headers = {'x-rapidapi-key': appo,'x-rapidapi-host': "api-football-beta.p.rapidapi.com"}
    response = requests.request("GET", url, headers=headers, params=querystring)
    a = response.json()
    b = a.get("response")
...
async def _(event):
    ...
    appo = Config.FOOTBALL_API_KEY
    url = "https://api-football-beta.p.rapidapi.com/standings"
    querystring = {"season":"2020-2021-2021","league":"2"}
    headers = {'x-rapidapi-key': appo,'x-rapidapi-host': "api-football-beta.p.rapidapi.com"}
    response = requests.request("GET", url, headers=headers, params=querystring)
    a = response.json()
    b = a.get("response")

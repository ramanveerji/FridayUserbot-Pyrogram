...
async def holastark2(event):
    ...
    myFont3 = ImageFont.truetype('Fonts/sign.otf', 200)
    d1.text((1609, 1481), text, font=myFont, fill=(51, 51, 51))
    TZ = pytz.timezone(Config.TZ)
    datetime_tz = datetime.now(TZ)
    oof = datetime_tz.strftime(f"%Y/%m/%d")
    d1.text((961, 2185), oof, font=myFont2, fill=(51, 51, 51))
    d1.text((2417, 2009), random.choice(famous_people), font=myFont3, fill=(51, 51, 51))
